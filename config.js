...
window.PLATACO_STRIPE_PK = 'pk_test_TU_CLAVE_PUBLICA_AQUI';
...
window.PLATACO_GOOGLE_CLIENT_ID = 'TU_GOOGLE_CLIENT_ID.apps.googleusercontent.com'; // ← pega aquí tu Google Client ID
